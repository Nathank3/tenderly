                                                ...
                                                <div class="shopping-cart-btn">
                                                    <span class="">
                                                        <a href="index.php"
                                                            ...
                                                            browsing</a>
                                                        <input type="submit" name="submit" value="update bookings"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="cart-product-sub-total"><span
                                                    class="cart-sub-total-price"><?php echo "Ksh." . " " . $row['productPrice']; ?>.00</span>
                                            </td>
                                            <td class="cart-product-sub-total"><span
                                                    class="cart-sub-total-price"><?php echo "Ksh." . " " . $row['shippingCharge']; ?>.00</span>
                                            </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing Address"> Address
                                                    1<span>*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing State ">State
                                                    <span>*</span></label>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing State "> County
                                                    <span>*</span></label>
                                                <input type="text" class="form-control unicase-form-control text-input"
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Billing City"> Town
                                                    <span>*</span></label>
                                                <input type="text" class="form-control unicase-form-control text-input"
