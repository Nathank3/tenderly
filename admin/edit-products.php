...
<head>
	...
	<title>Admin| Insert Tender</title>
...
<div class="controls">
<input type="text"    name="productName"  placeholder="Enter Tender Name" value="<?php echo htmlentities($row['productName']);?>" class="span8 tip" >
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Tender Application charges</label>
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Enter Tender Application charges" value="<?php echo htmlentities($row['shippingCharge']);?>" class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Tender Availability</label>
<div class="controls">
